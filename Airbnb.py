...
icon = Image.open(r"D:\Airbnb project\title.jpeg")
st.set_page_config(page_title= "Airbnb Data Visualization | By Aakash Magesh",
                   page_icon= icon,
                   layout= "wide",
...
csv_file_path = r'D:\Airbnb project\Airbnb_data.csv'
df = pd.read_csv(csv_file_path)


if selected == "Home":
    # Title Image
    st.image(Image.open(r"D:\Airbnb project\Ho.jpeg"),width=800)
